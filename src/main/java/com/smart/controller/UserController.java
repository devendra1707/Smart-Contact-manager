...
public class UserController {
	...
	// method for getting common data response when we create any handler method in this class comman data methoda always invoke
	@ModelAttribute
	...
	@GetMapping("/add-contact")  //user contact form
...
// its in normal folder 
	...
	public String updateHandler(@ModelAttribute Contact contact, @RequestParam("profileImage") MultipartFile file,
		...
		// check if person has a selected new img we gonna rewrite or is it empty
		try {
			// old photo del fetch
	...
	// creating order for payment
	 ...
	 @ResponseBody public String createOrder(@RequestBody Map<String, Object> data, Principal principal) throws Exception
	 { 
	 System.out.println("Hey order function executed"); 
	 System.out.println(data);
	 int amt = Integer.parseInt(data.get("amount").toString()); // in java 11 we can use var in the place of creating an object i
	 RazorpayClient client = new RazorpayClient("rzp_test_04kQ0xvYM5sa3w", "1MsfnWDTZfyCX4WTRC91eArF");
	  
	  JSONObject ob = new JSONObject(); 
	  ob.put("amount", amt*100); // converting into rupees that why we multipy with 100 
	  ob.put("currency", "INR");
	  ob.put("receipt", "txn_235425"); 
	  //creating order new and getting it Order
